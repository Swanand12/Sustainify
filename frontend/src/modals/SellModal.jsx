...
const SellModal = () => {
   ...
   return (
      <Dialog className=" ">
         <DialogTrigger
            onClick={() => {
               !connectWallet && toast.error("You have to connect your wallet first");
            }}
         ...
         {connectWallet && (
            <DialogContent className=" font-[500] border-none px-10">
               <DialogHeader>
                  <DialogTitle className="text-3xl text-[#1EDE25]  mb-3 ">Sell Energy</DialogTitle>
                  <span className="text-[#de1e1e]  tracking-wide pl-1">{error}</span>
                  <DialogDescription className="flex flex-col pb-4 pt-1 gap-4">
                     <BarLoader color="#1EDE25" loading={loading} width="100%" height={3} />
                     <div className="flex flex-col">
                        <label className="text-[#a3a09c] pl-1  mb-2 text-lg">Address</label>
                        <input
                           type="text"
                     ...
                     <div className="flex flex-col">
                        <label className="text-[#a3a09c] pl-1  mb-2 text-lg">Energy Tokens</label>
                        <input
                           type="number"
                           onChange={(e) => setEnergyTokensToSell(parseFloat(e.target.value))}
                     ...
                     <div className="flex flex-col">
                        <label className="text-[#a3a09c] pl-1  mb-2 text-lg">Bidding Price</label>
                        <input
                           type="number"
                     ...
                     <div className="flex flex-col">
                        <label className="text-[#a3a09c] pl-1  mb-2 text-lg">Bid Closing Time</label>
                        <input
                           type="datetime-local"
                     ...
                     <button
                        onClick={sellEnergy}
                        className="text-lg rounded-lg hover:opacity-90 text-black  mt-6 py-2 text-white bg-[#1EDE25] text-center tracking-wide"
                     >
                        Sell Energy
                     </button>
                  </DialogDescription>
