...
const FAQs = () => {
   ...
   return (
      <div className="py-[10rem] px-[10rem] ">
         ...
         >
            <h1 className="text-[3rem] text-[#42cdf8] font-[400]  mb-8  tracking-wide">FAQ's</h1>
         </motion.div>
         <motion.div
         ...
         >
            {faqsdata.map((f, i) => (
               <Accordion className="bg-[#f8f8f8] border-2 dark:border-[#2f3e5d] dark:bg-[#19202e] rounded-lg  " key={i} type="single" collapsible>
                  <AccordionItem
                     className="accordion   mx-10  rounded-lg "
                     value={`item-${i}`}
                  >
                     <AccordionTrigger className="accordion-trigger bg-[#f8f8f8]  dark:bg-[#19202e] text-xl font-[400]  text-[#42cdf8]">
                        <p className="flex items-center gap-4">
                           <FaCircleArrowRight />
                           {f.question}
                        </p>
                     </AccordionTrigger>
                     <AccordionContent className=" bg-[#f8f8f8]  dark:bg-[#19202e] pt-4 text-lg font-[300]">{f.answer}</AccordionContent>
                  </AccordionItem>
               </Accordion>
            ))}
         </motion.div>
